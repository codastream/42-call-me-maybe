...
run_test "Empty list" uv run python -m src --functions_definition 'data/input/functions_definition_robustness_crash_empty_list.json'
...
echo -e "$BLUE=schema=$NOC"
run_test "Empty list" uv run python -m src --input 'function_calling_tests_robustness_crash_empty_list.json'
